...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.delete('/transcripts/:studentID',
            ...(fetchMiddlewares<RequestHandler>(TranscriptsController)),
            ...(fetchMiddlewares<RequestHandler>(TranscriptsController.prototype.deleteStudent)),

            function TranscriptsController_deleteStudent(request: any, response: any, next: any) {
            const args = {
                    studentID: {"in":"path","name":"studentID","required":true,"ref":"db.StudentID"},
            };
        ...
        app.post('/transcripts/:studentID/:courseNumber',
            ...
            const args = {
                    ...
                    reqBody: {"in":"body","name":"reqBody","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"courseGrade":{"dataType":"double","required":true}}},
            };
